      ...
      <div className="flex flex-col lg:flex-row items-center max-w-6xl w-full relative">
        ...
        <div className="relative w-full lg:w-1/2 mb-16 lg:mb-0">
          ...
          <div className="absolute left-0 bottom-0 transform -translate-x-1/3 translate-y-1/4 sm:-translate-x-1/4 sm:translate-y-1/4">
            <div className="relative w-[80vw] sm:w-[60vw] max-w-[280px] rounded-xl overflow-hidden">
              <img
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-16 h-16 bg-[#ED806D] rounded-full flex items-center justify-center shadow-lg cursor-pointer">
        ...
        <div className="w-full lg:w-1/2 px-0 lg:pl-16">
          <p className="text-base text-[#ee8961] font-medium font-sans mb-2">About Us</p>
          <h2 className="text-3xl lg:text-4xl font-sans text-[#232323] leading-snug mb-4">
            Solving Problems That are Beyond your Control
          </h2>
          <p className="text-gray-500 text-lg font-sans leading-relaxed mb-6">
            Quis nostrud exercitation ullamco laboris nisi aut aliquip <br />
            modo consequat ruis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.
          </p>
